...
G4bool musrRootOutput::store_parIniTime = true;   // Y. ZENG 23 Apr 2024
G4bool musrRootOutput::store_parIniPosX = true;   // Y. ZENG 23 Apr 2024
G4bool musrRootOutput::store_parIniPosY = true;   // Y. ZENG 23 Apr 2024
G4bool musrRootOutput::store_parIniPosZ = true;   // Y. ZENG 23 Apr 2024
G4bool musrRootOutput::store_parIniMomX = true;   // Y. ZENG 23 Apr 2024
G4bool musrRootOutput::store_parIniMomY = true;   // Y. ZENG 23 Apr 2024
G4bool musrRootOutput::store_parIniMomZ = true;   // Y. ZENG 23 Apr 2024
G4bool musrRootOutput::store_parID = true;        // Y. ZENG 23 Apr 2024
...
void musrRootOutput::BeginOfRunAction() {
    ...
    if (store_parIniTime)   {rootTree->Branch("parIniTime",&parIniTime,"parIniTime/D");}       // Y. ZENG 23 Apr 2024
    if (store_parIniPosX)   {rootTree->Branch("parIniPosX",&parIniPosX,"parIniPosX/D");}       // Y. ZENG 23 Apr 2024
    if (store_parIniPosY)   {rootTree->Branch("parIniPosY",&parIniPosY,"parIniPosY/D");}       // Y. ZENG 23 Apr 2024
    if (store_parIniPosZ)   {rootTree->Branch("parIniPosZ",&parIniPosZ,"parIniPosZ/D");}       // Y. ZENG 23 Apr 2024
    if (store_parIniMomX)   {rootTree->Branch("parIniMomX",&parIniMomX,"parIniMomX/D");}       // Y. ZENG 23 Apr 2024
    if (store_parIniMomY)   {rootTree->Branch("parIniMomY",&parIniMomY,"parIniMomY/D");}       // Y. ZENG 23 Apr 2024
    if (store_parIniMomZ)   {rootTree->Branch("parIniMomZ",&parIniMomZ,"parIniMomZ/D");}       // Y. ZENG 23 Apr 2024
    if (store_parID)        {rootTree->Branch("parID",&parID,"parID/I");}                      // Y. ZENG 23 Apr 2024
...
void musrRootOutput::ClearAllRootVariables() {
    ...
    parIniTime=-1000;                                         // Y. ZENG 23 Apr 2024
    parIniPosX=-1000; parIniPosY=-1000; parIniPosZ=-1000;     // Y. ZENG 23 Apr 2024
    parIniMomX=-1000; parIniMomY=-1000; parIniMomZ=-1000;     // Y. ZENG 23 Apr 2024
    parID=-1000;                                              // Y. ZENG 23 Apr 2024
    muDecayDetID=-1000;
