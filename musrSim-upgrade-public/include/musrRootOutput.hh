...
public:
    ...
    void SetInitialParInfo(G4double x, G4double y, G4double z, G4double px, G4double py, G4double pz,
                            G4double particleTime, G4int particleID) {
        parIniTime=particleTime/CLHEP::microsecond;
        parIniPosX=x;  parIniPosY=y;  parIniPosZ=z;
        parIniMomX=px; parIniMomY=py; parIniMomZ=pz;
        parID=particleID;
    }   // Added by Y. ZENG 23 Apr 2024 to store the initial particle information
...
public:
    ...
    static G4bool store_parIniTime;   // Y. ZENG 23 Apr 2024
    static G4bool store_parIniPosX;   // Y. ZENG 23 Apr 2024
    static G4bool store_parIniPosY;   // Y. ZENG 23 Apr 2024
    static G4bool store_parIniPosZ;   // Y. ZENG 23 Apr 2024
    static G4bool store_parIniMomX;   // Y. ZENG 23 Apr 2024
    static G4bool store_parIniMomY;   // Y. ZENG 23 Apr 2024
    static G4bool store_parIniMomZ;   // Y. ZENG 23 Apr 2024
    static G4bool store_parID;        // Y. ZENG 23 Apr 2024
...
private:
    ...
    Double_t parIniTime;                           // Y. ZENG 23 Apr 2024
    Double_t parIniPosX, parIniPosY, parIniPosZ;   // Y. ZENG 23 Apr 2024
    Double_t parIniMomX, parIniMomY, parIniMomZ;   // Y. ZENG 23 Apr 2024
    Int_t    parID;                                // Y. ZENG 23 Apr 2024
    Int_t    muDecayDetID;
